...
@section('main')
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 mx-auto text-center">
                <a href="{{route('userConfirmationEmail', ['userId' => $user->id, 'userToken' => sha1($user->email)])}}"
                   class="btn text-white btn-primary btn-block btn-round">
                    CLICK AQUI PER A CONFIRMAR L'USUARI
                </a>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card card-profile card-plain">
                    <div class="card-body ">
                        <h2 class="card-title text-info">Política de privacitat</h2>
                    </div>
                </div>
            </div>
        </div>
